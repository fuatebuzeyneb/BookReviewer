...
import 'package:book_reviewer/views/widgets/comments/add_comment_and_rate_widget.dart';
...
class BookDetailsView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      bool isLoading = commentController.isLoading.value ||
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            bookController.selectedBook!.comments.isEmpty
                                ? Padding(
                                                                ...
                                                                ButtonWidget(
                                                                  onTap:
                                                                    ...
                                                                    commentController.deleteComment(
                                                                        ...
                                                                        index:
                                                                            index);
                                                                    await bookController.loadBookById(
                                                                        bookController
                                                                            .selectedBook!
                                                                            .id);
                                                                  },
